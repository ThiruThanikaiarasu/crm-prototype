 ...
 *   patch:
 *     summary: Restore a deleted call log
 *     description: |
 *       Restore a previously archived (soft-deleted) call log.
 *     tags: [Call Logs]
 *     security:
 *       - bearerAuth: []
 *
 ...
 *         name: id
 *         required: true
 *         description: Call log ID to restore
 *         schema:
 *           type: string
 *           example: "6956cf22e0161b73d5ccd850"
 *
 *     responses:
 *       200:
 *         description: Call log restored successfully
 *         content:
 *           application/json:
 *             example:
 ...
 *
 *       400:
 *         description: Validation error — invalid or missing call log ID
 *         content:
 *           application/json:
 *             example:
 *               message: "Invalid call log id"
